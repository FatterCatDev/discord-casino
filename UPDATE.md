...
- Dealer lists now auto-correct expired active dealers into paused status so upkeep state stays accurate.

## Bug Fixes

<!-- Add one bullet per bug fix that players may notice. -->
- Fixed an issue where the Unpause Dealer action could reactivate dealers even when their upkeep timer had already expired.
