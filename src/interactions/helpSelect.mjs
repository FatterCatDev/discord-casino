  ...
  sections.push({
    ...
    groups: [
      ...
      { label: '🎮 Games', items: [
        ...
        { emoji: '🏇', cmd: '/horserace', desc: kittenMode ? 'Wager on five flamboyant racers; change mounts between stages (for a flirty fee).' : 'Bet on a five-horse race; you can switch picks each stage for a 20% fee.' }
      ]}
    ]
  });
